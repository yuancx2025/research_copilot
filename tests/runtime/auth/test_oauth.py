...
import httpx
import pytest
from research_copilot.runtime.auth.connection import ConnectionService as _ConnectionService, StoredTokenAuth
from research_copilot.sources.notion.oauth import NOTION_URL, NotionAuthProvider
...
def ConnectionService(store=None, **kwargs):
    return _ConnectionService(NotionAuthProvider(), store, **kwargs)
