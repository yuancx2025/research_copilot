...
from research_copilot.runtime.mcp.config import parse_server_config, HttpConfig
from research_copilot.runtime.mcp.client import create_client
...
async def test_http_transport_with_real_sdk():
    from tests.runtime.mcp.fixture_server import mcp
