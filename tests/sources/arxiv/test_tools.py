...
class TestArxivToolkit:
    ...
    @patch('research_copilot.sources.arxiv.tools.arxiv')
    ...
    @patch('research_copilot.sources.arxiv.tools.ArxivLoader')
    ...
    def test_get_paper_content_with_url(self):
        ...
        with patch('research_copilot.sources.arxiv.tools.ArxivLoader') as mock_loader:
            mock_doc = MagicMock()
    ...
    def test_find_related_papers(self):
        ...
        with patch('research_copilot.sources.arxiv.tools.arxiv') as mock_arxiv:
            mock_paper = MagicMock()
