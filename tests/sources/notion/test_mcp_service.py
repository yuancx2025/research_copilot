...
from research_copilot.sources.notion.mcp_service import NotionMCPService, payload, page_id
from research_copilot.sources.notion.tools import NotionToolkit
from research_copilot.runtime.mcp.client import AuthorizationRequired, MCPToolError
from research_copilot.sources.notion.agent import NotionAgent
from tests.runtime.auth.test_oauth import MemoryStore, record, ConnectionService
...
async def connected_service(access='available'):
    ...
    with patch('research_copilot.sources.notion.mcp_service.create_client',
