...
class TestWebToolkit:
    ...
    def test_web_search_with_api(self):
        ...
        toolkit = WebToolkit(config)
        toolkit._tavily = MagicMock()
        toolkit._tavily.invoke.return_value = [
            {
                "title": "Test Article",
    ...
    @patch('research_copilot.sources.web.tools.requests.get')
    ...
    def test_error_handling(self):
        ...
        with patch('research_copilot.sources.web.tools.requests.get') as mock_get:
